...
async def admin_panel_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif data == "admin_help_main":
        await show_admin_help(query)
    elif data.startswith("admin_help_section_"):
        # Handle help section navigation
        if data == "admin_help_section_definition":
            await show_help_definition(query)
        elif data == "admin_help_section_commands":
            await show_help_commands(query)
        elif data == "admin_help_section_join":
            await show_help_join(query)
        elif data == "admin_help_section_users":
            await show_help_users(query)
        elif data == "admin_help_section_items":
            await show_help_items(query)
        elif data == "admin_help_section_broadcast":
            await show_help_broadcast(query)
        elif data == "admin_help_section_faq":
            await show_help_faq(query)
        elif data == "admin_help_section_emergency":
            await show_help_emergency(query)
...
async def show_admin_help(query):
    """نمایش راهنما"""
    text = """
📚 **راهنمای جامع پنل ادمین**

به راهنمای پنل مدیریت نانوکوین خوش آمدید! 🎮

در این راهنما، تمام دستورات و قابلیت‌های پنل ادمین را به صورت کامل یاد می‌گیرید.

**📑 بخش‌های راهنما:**

📖 تعریف بخش‌ها - آشنایی با هر بخش پنل
⌨️ دستورات اصلی - لیست کامل دستورات
🔗 مدیریت جوین - راهنمای سیستم جوین اجباری
👥 مدیریت کاربران - راهنمای کار با کاربران
🎮 مدیریت آیتم‌ها - راهنمای آیتم‌ها
📢 ارسال همگانی - راهنمای ارسال پیام
❓ سوالات متداول - پاسخ سوالات رایج
🚨 اضطراری - دستورات بحرانی
...
async def admin_help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await show_admin_help_main(update.message)


async def show_admin_help_main(message):
    """نمایش منوی اصلی راهنما"""
    text = """
📚 **راهنمای جامع پنل ادمین**
...
async def show_help_definition(query):
    """نمایش بخش تعریف"""
    text = """
📖 **تعریف بخش‌های پنل ادمین**

**📊 آمار و تحلیل:**
• نمایش آمار کاربران، اقتصاد، آیتم‌ها
• مشاهده جدول برترین‌ها
• گزارش کاربران فعال
• تحلیل رشد و روند‌ها

**👥 مدیریت کاربران:**
• جستجو و مشاهده جزئیات کاربران
• دادن و کم کردن سکه و الماس
• مسدود کردن و رفع مسدودی
• ریست و حذف کاربران
...
**🔗 مدیریت جوین:**
• افزودن گروه/کانال جدید
• تنظیم پیام خوشامدگویی
• فعال/غیرفعال کردن
• بررسی وضعیت عضویت

**⚙️ تنظیمات:**
• تنظیمات عمومی و بازی
• تنظیمات اقتصادی
• تنظیمات امنیتی
• تنظیمات اعلان
...
**📋 لاگ‌ها:**
• مشاهده لاگ امروز و دیروز
• جستجو در لاگ
• گزارش عملیات
"""
    
    keyboard = [
        [InlineKeyboardButton("🔙 بازگشت به راهنما", callback_data="admin_help_main")],
        [InlineKeyboardButton("🏠 بازگشت به پنل", callback_data="admin_main")],
    ]
...
async def show_help_commands(query):
    """نمایش بخش دستورات"""
    text = """
⌨️ **دستورات اصلی پنل ادمین**

**📱 دستورات کلی:**
• `/admin` - باز کردن پنل ادمین
• `/admin_help` - نمایش راهنما

**👥 مدیریت کاربران:**
• `/admin_users` - لیست کاربران
• `/admin_search_user [آیدی/نام]` - جستجوی کاربر
• `/admin_give_coins [آیدی] [مقدار]` - دادن سکه
• `/admin_give_diamonds [آیدی] [مقدار]` - دادن الماس
• `/admin_ban_user [آیدی] [دلیل]` - مسدود کردن
• `/admin_unban_user [آیدی]` - رفع مسدودی
• `/admin_reset_user [آیدی]` - ریست کاربر
• `/admin_delete_user [آیدی]` - حذف کاربر

**🎮 مدیریت آیتم‌ها:**
• `/admin_items` - لیست آیتم‌ها
• `/admin_add_item [نام] [ایموجی] [قیمت]` - اضافه کردن
• `/admin_set_price [آیدی آیتم] [قیمت]` - تنظیم قیمت
• `/admin_item_stats [آیدی آیتم]` - آمار آیتم

**🎯 ماموریت‌ها:**
• `/admin_add_quest` - اضافه کردن ماموریت
• `/admin_edit_quest [آیدی]` - ویرایش ماموریت
• `/admin_delete_quest [آیدی]` - حذف ماموریت
• `/admin_reset_quests [آیدی کاربر]` - ریست ماموریت‌ها

**💎 اقتصاد:**
• `/admin_economy_report` - گزارش اقتصادی
• `/admin_economy_add_coins [آیدی] [مقدار]` - اضافه سکه
• `/admin_economy_add_diamonds [آیدی] [مقدار]` - اضافه الماس

**🔗 مدیریت جوین:**
• `/admin_join` - پنل مدیریت جوین
• `/admin_join_add [چت آیدی]` - افزودن گروه
• `/admin_join_remove [آیدی]` - حذف گروه
• `/admin_join_list` - لیست گروه‌ها
• `/admin_join_message [پیام]` - تنظیم پیام
• `/admin_join_toggle [آیدی]` - فعال/غیرفعال
• `/admin_join_test [آیدی کاربر]` - تست کاربر
• `/admin_join_check_all` - بررسی همه
• `/admin_join_stats` - آمار جوین

**📢 ارسال همگانی:**
• `/admin_broadcast [پیام]` - ارسال همگانی
• `/admin_dm [آیدی] [پیام]` - پیام خصوصی
• `/admin_announce [پیام]` - اطلاعیه

**📊 آمار:**
• `/admin_stats` - آمار کلی
• `/admin_leaderboard` - جدول برترین‌ها
• `/admin_active_users` - کاربران فعال

**⚙️ تنظیمات:**
• `/admin_get_setting [کلید]` - دریافت تنظیم
• `/admin_set_setting [کلید] [مقدار]` - تنظیم مقدار

**📋 لاگ‌ها:**
• `/admin_search_logs [کلمه]` - جستجو در لاگ
"""
...
async def show_help_join(query):
    """نمایش بخش جوین اجباری"""
    text = """
🔗 **راهنمای سیستم جوین اجباری**

سیستم جوین اجباری کاربران را مجبور به عضویت در گروه‌ها و کانال‌های مشخص می‌کند قبل از استفاده از ربات.

**➕ افزودن گروه/کانال جدید:**
```
/admin_join_add [چت آیدی]
```
مثال: `/admin_join_add -1001234567890`

روبات به صورت خودکار اطلاعات گروه را دریافت می‌کند.

**➖ حذف گروه/کانال:**
```
/admin_join_remove [آیدی الزام]
```
مثال: `/admin_join_remove 1`

**✏️ ویرایش پیام خوشامدگویی:**
```
/admin_join_message [آیدی] [پیام]
```
مثال: `/admin_join_message 1 سلام! خوش آمدید`

**✅ فعال/غیرفعال کردن:**
```
/admin_join_toggle [آیدی]
```
گروه را بدون حذف کردن فعال یا غیرفعال می‌کند.

**📋 مشاهده لیست:**
```
/admin_join_list
```
تمام گروه‌ها و وضعیت آن‌ها را نمایش می‌دهد.

**🧪 تست جوین برای یک کاربر:**
```
/admin_join_test [آیدی کاربر]
```
بررسی می‌کند که آیا کاربر در تمام گروه‌ها عضو است یا خیر.

**📊 بررسی تمام کاربران:**
```
/admin_join_check_all
```
آمار تأیید شده و تأیید نشده‌ها را نمایش می‌دهد.

**🔍 دیباگ سیستم:**
```
/admin_join_debug
```
اطلاعات کامل سیستم جوین را نمایش می‌دهد.

**🧪 تست تأیید شده کاربر:**
```
/admin_join_verify_test [آیدی کاربر]
```
بررسی تفصیلی وضعیت عضویت کاربر.

**📊 تست تمام کاربران:**
```
/admin_join_verify_all
```
آمار دقیق تأیید کاربران.

**⚠️ نکات مهم:**
1. ربات باید در گروه‌ها ادمین باشد
2. گروه‌ها باید دسترسی لازم را بدهند
3. لینک دعوت باید معتبر باشد
4. از `/admin_join_debug` برای عیب‌یابی استفاده کنید
"""
...
async def show_help_users(query):
    """نمایش بخش کاربران"""
    text = """
...
**🔍 جستجوی کاربر:**
```
/admin_search_user [آیدی/نام/یوزرنیم]
```
مثال: `/admin_search_user ali`
مثال: `/admin_search_user @username`
مثال: `/admin_search_user 123456789`

**💰 دادن سکه:**
```
/admin_give_coins [آیدی کاربر] [مقدار سکه]
```
مثال: `/admin_give_coins 123456789 1000`

**💎 دادن الماس:**
```
/admin_give_diamonds [آیدی کاربر] [مقدار الماس]
```
مثال: `/admin_give_diamonds 123456789 50`

**🚫 مسدود کردن کاربر:**
```
/admin_ban_user [آیدی کاربر] [دلیل]
```
مثال: `/admin_ban_user 123456789 تخلف`
دلیل اختیاری است اما توصیه می‌شود.

**🔓 رفع مسدودی:**
```
/admin_unban_user [آیدی کاربر]
```
مثال: `/admin_unban_user 123456789`

**🔄 ریست کاربر:**
```
/admin_reset_user [آیدی کاربر]
```
تمام سکه‌ها، الماس‌ها و آیتم‌ها ریست می‌شوند.
⚠️ این عملیات برگشت‌پذیر نیست!

**🗑 حذف کاربر:**
```
/admin_delete_user [آیدی کاربر]
```
کاربر به صورت کامل از دیتابیس حذف می‌شود.
⚠️ این عملیات برگشت‌پذیر نیست!
...
/admin_users
```
لیست کاربران با قابلیت صفحه‌بندی نمایش داده می‌شود.

**⚠️ نکات مهم:**
1. قبل از حذف، از پنل استفاده کنید
2. دلیل مسدودی را همیشه ذکر کنید
3. ریست و حذف برگشت‌پذیر نیست
4. عملیات در لاگ ثبت می‌شود
"""
...
async def show_help_items(query):
    """نمایش بخش آیتم‌ها"""
    text = """
🎮 **راهنمای مدیریت آیتم‌ها**

**➕ اضافه کردن آیتم:**
```
/admin_add_item [نام] [ایموجی] [قیمت سکه] [قیمت الماس]
```
مثال: `/admin_add_item شمش طلا 🗡️ 100 10`
...
**💰 تنظیم قیمت:**
```
/admin_set_price [آیدی آیتم] [قیمت سکه] [قیمت الماس]
```
مثال: `/admin_set_price 1 200 20`

**📊 آمار آیتم:**
```
/admin_item_stats [آیدی آیتم]
```
تعداد فروش و آمار آیتم را نمایش می‌دهد.

**📋 لیست آیتم‌ها:**
```
/admin_items
```
لیست تمام آیتم‌ها با قابلیت صفحه‌بندی.

**⚠️ نکات مهم:**
1. ایموجی باید از قبل در تلگرام موجود باشد
2. قیمت می‌تواند 0 باشد (رایگان)
3. حذف آیتم برگشت‌پذیر نیست
4. قیمت‌های منفی مجاز نیستند
"""
...
async def show_help_broadcast(query):
    """نمایش بخش ارسال همگانی"""
    text = """
📢 **راهنمای ارسال همگانی**

**📝 ارسال پیام متنی:**
```
/admin_broadcast [پیام]
```
مثال: `/admin_broadcast سلام! اطلاعیه جدید`
...
1. ارسال همگانی
2. ارسال زمان‌بندی
3. تنظیم تاریخ و ساعت

**💬 ارسال پیام خصوصی:**
```
/admin_dm [آیدی کاربر] [پیام]
```
مثال: `/admin_dm 123456789 سلام!`

**📢 اطلاعیه:**
```
/admin_announce [پیام]
```
ارسال به تمام کاربران با قابلیت پیگیری.

**📈 مشاهده وضعیت ارسال‌ها:**
از پنل ادمین استفاده کنید:
1. ارسال همگانی
2. وضعیت ارسال‌ها

**⚠️ نکات مهم:**
1. پیام طولانی ممکن است کوتاه شود
2. ارسال همگانی زمان‌بر است
3. حتماً قبل از ارسال تست کنید
4. از `/admin_broadcast` برای ارسال سریع استفاده کنید
5. پیام‌ها در لاگ ثبت می‌شوند
"""
...
async def show_help_faq(query):
    """نمایش بخش سوالات متداول"""
    text = """
❓ **سوالات متداول**

**❓ کاربر نمی‌تواند عضو شود؟**
• بررسی کنید آیا لینک دعوت معتبر است
• ربات در گروه ادمین باشد
• دسترسی‌های لازم را بررسی کنید
• از `/admin_join_debug` استفاده کنید

**❓ چطور کاربر را دستی تأیید کنم؟**
• کاربر باید واقعاً عضو شود
• سیستم به صورت خودکار بررسی می‌کند
• تأیید دستی وجود ندارد

**❓ ربات به گروه نمی‌تواند بپیوندد؟**
• لینک دعوت را چک کنید
• ربات ادمین باید در گروه باشد
• دسترسی‌های ربات را بررسی کنید

**❓ آمار کاربران صحیح نیست؟**
• از `/admin_join_check_all` استفاده کنید
• دیتابیس را بررسی کنید
• کاربران غیرفعال را حذف کنید

**❓ چطور کاربر غیرفعال را حذف کنم؟**
• از `/admin_join_remove_all_inactive` استفاده کنید
• این عملیات برگشت‌پذیر نیست!

**❓ پیام خوشامدگویی نمایش داده نمی‌شود؟**
• پیام را از `/admin_join_message` تنظیم کنید
• اطمینان حاصل کنید گروه فعال است
• از `/admin_join_toggle` بررسی کنید

**❓ ارسال همگانی گیر می‌کند؟**
• تعداد زیاد است؟ منتظر بمانید
• اینترنت را بررسی کنید
• از وضعیت ارسال‌ها بررسی کنید

**❓ سکه/الماس کم شد؟**
• از `/admin_economy_report` بررسی کنید
• کاربران را بررسی کنید
• لاگ‌ها را چک کنید

**❓ چطور بفهمم کدام کاربر مشکل دارد؟**
• از `/admin_join_verify_test [آیدی]` استفاده کنید
• وضعیت دقیق کاربر نمایش داده می‌شود

**❓ بهترین روش برای مدیریت چیست؟**
• روزانه آمار را چک کنید
• لاگ‌ها را مرور کنید
• از پنل ادمین استفاده کنید
• دستورات را از راهنما یاد بگیرید
"""
...
async def show_help_emergency(query):
    """نمایش بخش اضطراری"""
    text = """
🚨 **دستورات اضطراری**

**⚠️ هشدار: این دستورات خطرناک هستند!**
فقط در صورت لزوم و با دقت استفاده کنید.

**🧹 پاکسازی کاربران غیرفعال:**
```
/admin_join_remove_all_inactive
```
تمام کاربرانی که در گروه‌ها عضو نیستند را حذف می‌کند.
⚠️ برگشت‌پذیر نیست!

**🔄 ریست کامل کاربر:**
```
/admin_reset_user [آیدی]
```
تمام داده‌های کاربر را پاک می‌کند.
⚠️ برگشت‌پذیر نیست!

**🗑 حذف کامل کاربر:**
```
/admin_delete_user [آیدی]
```
کاربر را از دیتابیس حذف می‌کند.
⚠️ برگشت‌پذیر نیست!

**📊 بررسی فوری تمام کاربران:**
```
/admin_join_check_all
```
وضعیت همه کاربران را بررسی می‌کند.

**🔍 دیباگ سیستم:**
```
/admin_join_debug
```
اطلاعات کامل سیستم را نمایش می‌دهد.

**📋 جستجو در لاگ‌ها:**
```
/admin_search_logs [کلمه]
```
عملیات‌ها را پیدا می‌کند.

**💾 بکاپ‌گیری:**
• از دیتابیس بکاپ بگیرید
• قبل از عملیات مهم بکاپ کنید
• فایل‌های بکاپ را در جای امن نگه دارید

**📞 تماس با پشتیبانی:**
در صورت مشکل جدی:
• لاگ‌ها را آماده کنید
• جزئیات عملیات را بنویسید
• منتظر راهنمایی باشید

**⚠️ قبل از استفاده از دستورات اضطراری:**
1. بکاپ بگیرید
2. مطمئن شوید دستور صحیح است
3. تأیید نهایی را دریافت کنید
